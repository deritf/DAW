...
public class Actividad318 {
    ...
    System.out.print("Este programa calcula el mínimo común multiplo de dos números introducidos por el usuario.\n");   
        ...
        System.out.println("=============================================");       
        System.out.println("El mínimo común multiplo es: [" + calculaElMcmDe(valor1, valor2) + "]");
    }
            ...
            public static int calculaElMcmDe(int valor1, int valor2){


                int mayor = Math.max(valor1, valor2);
                int menor = Math.min(valor1, valor2);
                
                int resultado = (mayor / calculaElMcdDe(valor1, valor2)) * menor;
